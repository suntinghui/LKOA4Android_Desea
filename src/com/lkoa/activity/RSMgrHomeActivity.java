...
public class RSMgrHomeActivity extends CenterMsgBaseActivity implements OnClickListener {
	...
	private void showDatePickerDialog() {
		...
		DatePickerDialog dialog = new DatePickerDialog(
				this, mOnDateSetListener, Integer.parseInt(date[0]), 
	...
	private boolean isAdmin() {
		if(mRSInfors == null) return false;
		
		if(TextUtils.equals(mRSInfors.adminFlag, "1")) return true;
		return false;
	}
	...
	public void onClick(View v) {
		...
		case R.id.user_name:
			...
			ContactsSelectorActivity.startForResult(this, 
					ContactsSelectorActivity.SELECT_MODE_SINGLE, mUserId);
			break;
			
		case R.id.search_start:
			//开始检索
			if(!TextUtils.equals(mLoginUserId, mUserId) && !isAdmin()) {
